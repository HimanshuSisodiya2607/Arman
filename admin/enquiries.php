...
$stmt = $pdo->query('SELECT id, name, email, message, created_at FROM enquiries ORDER BY created_at DESC');
...
<main class="main-content">
    <div class="container">
        <div style="margin-bottom: 48px;">
            ...
            <p style="color: var(--white-50); margin-top: 8px;">Name, email, message from the contact form</p>
        </div>
